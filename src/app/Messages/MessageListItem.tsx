  ...
  return (
    <div className="p-4 rounded-md bg-slate-900 flex flex-col gap-4">
      <div className="flex gap-10">
        ...
        <blockquote className="flex-1 text-xl font-semibold text-slate-900 dark:text-white flex gap-4 bg-slate-800 flex-grow min-h-full items-center justify-center rounded-md lg:text-3xl">
